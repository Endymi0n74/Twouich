...
Télécharger [`Twouich_v1.0.8.apk`](https://github.com/Endymi0n74/Twouich/releases/download/v1.0.8/Twouich_v1.0.8.apk) depuis la release publiée.

```bash
adb install -r Twouich_v1.0.8.apk
```
